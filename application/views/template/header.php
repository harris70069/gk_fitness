...
<html lang="en">
  <head>
    <title>成吉思汗健身俱樂部 進化綜合格鬥中心-健身、格鬥、舉重</title>
    <base href="http://localhost:8080/gk_fitness/">
    <meta charset="utf-8">
  ...
  <body>
  	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
     <img src="./assets/images/icon.png" style="width: 10%;" alt="">
	      <!-- <a class="navbar-brand" href="index.html">COACH. HARRIS<small>GK FITNESS CLUB</small></a> -->
